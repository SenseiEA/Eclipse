...
public class RegisterForm extends JFrame implements MouseListener, ActionListener{
	...
	public RegisterForm() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Eclipse\\HomeScreen\\src\\com\\Guoba.png"));
		...
		setContentPane(new JLabel(new ImageIcon("C:\\Eclipse\\HomeScreen\\src\\com\\LiyueBG.jpg")));
		lblBGImage=new JLabel();
		
		
		ImageIcon imageLogo=new ImageIcon("C:\\Eclipse\\HomeScreen\\src\\com\\WanminLogo.png");
